    ...
    <div style={{
      ...
      <div style={{ padding: "24px 20px", borderBottom: `1px solid ${C.border}` }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <img src="/logo.png" style={{ width: 32, height: 32, objectFit: "contain" }} alt="Shri Aaum" />
          <div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          <img src="/logo.png" style={{ width: 72, height: 72, objectFit: "contain", marginBottom: 8 }} alt="Shri Aaum" />
