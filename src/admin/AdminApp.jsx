    ...
    <div style={{
      ...
      <div style={{ padding: "24px 20px", borderBottom: `1px solid ${C.border}` }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <img src="/logo.jpg" style={{ width: 36, height: 36, objectFit: "cover", borderRadius: "50%" }} alt="Shri Aaum" />
          <div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          <img src="/logo.jpg" style={{ width: 80, height: 80, objectFit: "cover", borderRadius: "50%", marginBottom: 8, border: "2px solid rgba(245,200,66,.3)" }} alt="Shri Aaum" />
...
function Dashboard() {
  ...
  useEffect(() => {
    let cancelled = false;
    api.getOrderStats()
      .then(r => { if (!cancelled) setStats(r.stats || r); })
